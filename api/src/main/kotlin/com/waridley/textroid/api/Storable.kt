...
abstract class Storable<T>(open val id: StorageId<T>, open val storage: StorageInterface<T>) {
...
inline fun <reified J> storage(receiver: KCallable<J>,
                               noinline initializer: Storable<*>.() -> J) =
		Storage<J>(receiver.path).init(initializer)
...
inline fun <reified UJ> uniqueStorage(receiver: KCallable<UJ>,
                                      noinline initializer: Storable<*>.() -> UJ) =
		UniqueStorage<UJ>(receiver.path).init(initializer)